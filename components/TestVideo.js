...
export default function TestVideo({
  ...
  const playSoundAndPauseVideo = async () => {
    ...
    // stoppa bakgrundsloopen
    sharedAudioPlayer.stopBackgroundLoop();

    // TODO
    // hur kan vi byta ut spela upp ljud till:
    // sharedAudioPlayer.play(require("../assets/sounds/music/information.wav") );

    // och byta ut (rad 29) playbackStatus.didJustFinish till:
    // soundIsPlaying

    // problem:
    //information.wav spelas upp även i mute läge, men bör funka rätt om ovan fixas
    // placera mute och stäng knapp över overlay?
